    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-white overflow-hidden">
      ...
      <nav className="flex items-center justify-between px-10 py-6">
        ...
        <div className="flex items-center gap-8 text-sm">
          ...
          <a href="#submit" className="hover:opacity-80">Submit</a>
      ...
      <section className="relative px-10 pt-28 pb-40">
        ...
        >
          The <span className="text-white">curated</span> Discord server directory —
          <br />
      ...
      <section className="px-10 pb-32 grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-zinc-900/80 border-zinc-800">
          <CardContent className="p-6">
            ...
            <h3 className="text-lg font-semibold">Manually Approved</h3>
        ...
        <Card className="bg-zinc-900/80 border-zinc-800">
          <CardContent className="p-6">
            ...
            <h3 className="text-lg font-semibold">Quality Discovery</h3>
            <p className="mt-2 text-sm text-zinc-300">
      ...
      <section className="px-10 pb-32">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ["Strict Rules", "Low-effort servers are rejected."],
            ["Transparent Moderation", "Clear reasons for approval or rejection."],
            ["Community First", "Quality over quantity, always."],
          ].map(([title, desc]) => (
            <div key={title}>
